...
pub fn place_orde_external(ctx: Context<PlaceOrder>, order: Order, limit: u8) -> Result<Option<u128>> {
    ...
    msg!(
        "{} tokens of mint {} approved from user's account {} to market's vault {}",
        deposit_amount,
